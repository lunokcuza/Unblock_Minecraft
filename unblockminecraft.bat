...
::ZQ05rAF9IBncCkqN+0xwdVsEAlTMbSXsZg==
::ZQ05rAF9IAHYFVzEqQIAOhRTXgWPfG21FPUJ5ur34OmMq0MaFM82dorYyLWINIA=
::eg0/rx1wNQPfEVWB+kM9LVsJDDGMPme1Bb4x4eb+7PiGpFlTUfo6GA==
::fBEirQZwNQPfEVWB+kM9LVsJDDGMPme1Bb4x4eb+7PiGpFlTUfo6GA==
::cRolqwZ3JBvQF1fEqQIAOhRTXgWPfG21FPUJ5ur34OmMq0MaFM82dorYyLWINIA=
::dhA7uBVwLU+EWHWR+ks7Kw5OTWQ=
::YQ03rBFzNR3SWATElA==
::dhAmsQZ3MwfNWATE2Fc+IRBXWR6DfDnqVOR8
::ZQ0/vhVqMQ3MEVWAtB9wSA==
::Zg8zqx1/OA3MEVWAtB9wSA==
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFCt3cCCHL2CuCaUg3eb54+WEqQ0wXew6e53a3KCyFe4R5krnfrsk2H9ZisoKGFVdZhfL
::YB416Ek+ZG8=
::
::
...
if %var%==12 goto Uninstall_Minecraft
if %var%==13 goto Game Shake
if %var%==14 goto Calculator
if %var%==15 goto exit
:about
cls
echo This a program UnlockMinecraft. Release v. 0.1 30/05/21. This program has 109 lines. In comming updates, lines comes biggest.
echo.
pause
exit
:Launch Minecraft
...
:Download Minecraft
cls
echo https://tlauncher.org/ru/download_1/minecraft-1-17_11975.html
echo.
pause
exit
:Rules
